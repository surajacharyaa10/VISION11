...
Welcome to the **VISION11** soccer analytics pipeline! In sports, every centimeter and every second matter. This repository utilizes state-of-the-art computer vision models (YOLO, ByteTrack, Supervision) to extract powerful insights from soccer match footage. 

Our pipeline supports a variety of advanced features including detecting players, tracking the ball, classifying teams based on jersey colors, and rendering a top-down radar minimap view of the pitch.
